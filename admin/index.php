                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/show/<?php echo $row["id"] ?>" class="btn badge bg-primary"><i class="bi bi-eye"></i></a>
                                            <a href="/admin/edit/<?php echo $row["id"] ?>" class="btn badge bg-warning"><i class="bi bi-pencil-square"></i></a>
                                            <a href="/admin/delete/<?php echo $row["id"] ?>" class="btn badge bg-danger"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                    $i++;
