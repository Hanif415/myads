                    ...
                    <table class="table table-striped" style="font-size: larger;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/myads/admin/index.php/show<?php echo $row["id"] ?>"
                                        class="btn badge bg-primary"><i class="bi bi-eye"></i></a>
                                    <a href="/myads/admin/index.php/edit<?php echo $row["id"] ?>"
                                        class="btn badge bg-warning"><i class="bi bi-pencil-square"></i></a>
                                    <a href="/myads/admin/index.php/delete<?php echo $row["id"] ?>"
                                        class="btn badge bg-danger"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                            <?php
                                    $i++;
