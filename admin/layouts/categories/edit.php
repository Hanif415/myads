...
include('../../backend/categories/edit.php');
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form method="post" action="edit.php" enctype="multipart/form-data" class="mb-5">
                    <input type="text" hidden value="<?php echo $category_id ?>" name="id">
                    <div class="mb-3 col-lg-5">
                        <label for="name" class="form-label">Nama Kategori</label>
                        <input type="text" class="form-control <?php echo (!empty($name_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $category_name; ?>" id="name" name="name">
