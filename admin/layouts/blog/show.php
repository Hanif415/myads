                    ...
                    <div class="row my-3">
                        <div class="col-lg-8">
                            ...
                            <a href="blog.php" class="btn btn-success"><span data-feather="arrow-left"></span>
                                Back to all my
                                post</a>
                            <a href="edit.php?id=<?php echo $row["id"] ?>" class="btn btn-warning"><span
                                    data-feather="edit"></span>
                                Edit</a>
                            <form action="../../backend/blog/delete.php?id=<?php echo $row["id"] ?>" method="POST"
                                class="d-inline">
                                <button class="btn btn-danger" onclick="return confirm('Apakah kamku yakin?')"><span
                            ...
                            <br>
                            <p class="mt-3">Categories <span
                                    class="badge bg-secondary"><?php echo categoryName($blog_category_id) ?></span></p>
