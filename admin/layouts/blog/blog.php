                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/myads/admin/layouts/blog/show.php/<?php echo $row["id"] ?>" class="btn badge bg-primary"><i class="bi bi-eye"></i></a>
                                            <a href="/myads/admin/layouts/blog/edit.php/<?php echo $row["id"] ?>" class="btn badge bg-warning"><i class="bi bi-pencil-square"></i></a>
                                            <a href="/myads/admin/layouts/blog/delete.php/<?php echo $row["id"] ?>" class="btn badge bg-danger"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                    $i++;
