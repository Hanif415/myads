...
include('../../backend/authentication/login.php');
?>
                    ...
                    <div class="card text-black" style="border-radius: 25px;">
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-10 col-lg-4 d-flex align-items-center justify-content-center order-1 order-lg-2">
                                    <img src="../../../assets/images/myads.jpg" class="img-fluid" alt="Sample image">
                                </div>
                            </div>
                        </div>
                    </div>
